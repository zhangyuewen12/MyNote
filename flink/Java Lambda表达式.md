...
https://ci.apache.org/projects/flink/flink-docs-release-1.12/dev/java_lambdas.html 官网地址
...
This document shows how to use lambda expressions and describes current limitations. For a general introduction to the Flink API, please refer to the [DataSteam API overview](https://ci.apache.org/projects/flink/flink-docs-release-1.12/dev/datastream_api.html)
